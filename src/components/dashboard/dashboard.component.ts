  ...
  template: `
    <div class="max-w-4xl mx-auto p-4 md:p-6 space-y-8 pb-24">
      ...
      <div class="card-glass rounded-2xl p-6 border-t-4 border-t-purple-500">
        ...
        @if (portfolio.error()) {
          <div class="mt-4 bg-red-900/30 text-red-400 px-4 py-3 rounded-lg border border-red-900/50 text-sm flex items-center gap-2">
      ...
      <div class="space-y-4">
        ...
        @if (portfolio.positions().length === 0) {
          <div class="text-center py-12 border-2 border-dashed border-slate-700 rounded-xl bg-slate-800/20">
      ...
      @if (portfolio.history().length > 0) {
        <div class="mt-8 pt-8 border-t border-slate-800">
           ...
           <div class="space-y-2">
             @for (trade of portfolio.history(); track trade.id) {
               <div class="flex justify-between items-center text-sm p-3 rounded-lg bg-slate-800/30">
                 ...
                 <div class="flex items-center gap-4">
                   ...
                   @if (trade.type === 'SELL' && trade.pnl !== undefined) {
                     <span class="font-mono" [class]="trade.pnl >= 0 ? 'text-green-400' : 'text-red-400'">
